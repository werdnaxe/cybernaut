...
import merchAd from './merch-ad.png';
import cookieMonsterTitle from './cookie-monster-title.png';
import cookieOption from './cookie-option.png';
import cookieBadOutcomePlaceholder from './cookie-bad-outcome-placeholder.png';
...
const MM1 = () => {
  ...
  const moduleSegments = [
    ...
    },
    {
      ...
      type: "outcome",
      content: "Cookies can track what you buy or view, and that data can be shared with advertisers.",
      interactive: (
        <div className="flex flex-col items-center justify-center space-y-6 p-8">
          <img
            src={cookieBadOutcomePlaceholder} // TODO: Replace later
            alt="Bad Cookies Image"
            className="w-[300px] h-auto rounded-lg shadow-md"
          />
        </div>
      )
